...
mpeg2dec:3,mpegvparse:3,tsdemux:4,mpegtsbase:4,uridecodebin:5,filesrc:5,\
mpegtsdemux:4,xvimagesink:3,fakesink:5,strucutre:1,\
GST_REGISTRY:1,GST_EVENT:2,GST_SEGMENT:5,GST_ELEMENT_FACTORY:1,GST_ELEMENT_PAD:1,\
...
#
./test file=clock.mpg wait=5 rate=8 zero
#./test host=192.168.0.106 rrid=33 wait=5 rate=8 zero
