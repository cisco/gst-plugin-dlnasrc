...
mpeg2dec:3,mpegvparse:3,tsdemux:3,mpegtsbase:5,uridecodebin:5,filesrc:5,\
mpegtsdemux:4,xvimagesink:3,fakesink:5,\
GST_EVENT:2,GST_SEGMENT:2,GST_ELEMENT_FACTORY:1,GST_ELEMENT_PAD:1,GST_PADS:1,GST_STATES:1,GST_BUFFER:1,GST_BUS:1
export GST_DEBUG
#
...
#./test file=true_lies.mpg manual_elements wait=5 rate=4
#./test host=192.168.0.106 rrid=30 dtcp
